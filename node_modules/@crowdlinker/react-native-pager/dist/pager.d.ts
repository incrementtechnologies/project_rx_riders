...
declare function Pager({ activeIndex: parentActiveIndex, onChange: parentOnChange, initialIndex, children, springConfig, panProps, pageSize, threshold, minIndex, maxIndex: parentMax, adjacentChildOffset, style, containerStyle, type, pageInterpolation, clamp, clampDrag, animatedValue, }: iPager): JSX.Element;
declare type iPagerContext = [number, (nextIndex: number) => void, Animated.Value<number>];
declare const PagerContext: React.Context<[number, (nextIndex: number) => void, Animated.Value<number>] | undefined>;
...
declare function PagerProvider({ children, initialIndex, activeIndex: parentActiveIndex, onChange: parentOnChange, }: iPagerProvider): JSX.Element;
declare function usePager(): iPagerContext;
interface iFocusProvider {
    children: React.ReactNode;
    focused: boolean;
}
declare function FocusProvider({ focused, children }: iFocusProvider): JSX.Element;
declare function useFocus(): boolean;
interface iIndexProvider {
    children: React.ReactNode;
    index: number;
}
declare function IndexProvider({ children, index }: iIndexProvider): JSX.Element;
...
declare function useInterpolation(pageInterpolation: iPageInterpolation, index?: number): any;
export { Pager, PagerProvider, PagerContext, usePager, useFocus, useOffset, useOnFocus, useIndex, useAnimatedIndex, useInterpolation, IndexProvider, FocusProvider, };
